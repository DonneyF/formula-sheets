...
Radiation from an arbitrary source with approximations $r^\prime \ll r$, $r^\prime \ll c/\abs{\ddot{\rho}/\dot{\rho}}$ and dropping $1/r^2$ terms:\\
...
\tab $\ds \vb{B}(\vb{r}, t) \approx -\frac{\mu_0}{4\pi r c} [\vb{r} \cross \ddot{\vb{p}}]$\\
...
Li\'enard-Wiechert Potential and Fields ($\vb{u} = c\vu{\brcurs} - \vb{v}$):\\
...
\columnbreak
Larmor Formula:\\
\tab $\ds P = \frac{\mu_0 q a^2}{6 \pi c}$
