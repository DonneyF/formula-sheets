...
\begin{tabular}{ll}  
	...
	\midrule\vspace{1mm}
	$\ds \frac{px + q}{(x-a)(x-b)}$ & $\ds \frac{A}{x-a} + \frac{B}{x-b}$\\\vspace{1mm}
	$\ds \frac{px + q}{(x-a)^2}$ & $\ds \frac{A}{x-a} + \frac{B}{(x-a)^2}$\\\vspace{1mm}
	$\ds \frac{px^2 + qx + r}{(x-a)(x-b)(x-c)}$ & $\ds \frac{A}{x-a} + \frac{B}{x-b} + \frac{C}{x-c}$\\\vspace{1mm}
