...
Laplacian:\\
\tab $\ds \laplacian{f} = \frac{1}{r^2}\pdv{r}\left(r^2\pdv{f}{r}\right) +$\\
...
\tab $\ds \div{\vb{E}} = \frac{\rho}{\epsilon_0}$
...
\tab $\ds \oint \vb{E}\cdot d\vb{a} = \frac{Q_\text{enc}}{\epsilon_0}$

\tab $\ds \oint \vb{B}\cdot d\vb{a} = 0$

\tab $\ds \oint \vb{E}\cdot d\vb{l} = -\dv{\Phi_B}{t}$

\tab $\ds \oint \vb{B}\cdot d\vb{l} = \mu_0 I_\text{enc} + \epsilon_0\mu_0 \dv{\Phi_E}{t}$
